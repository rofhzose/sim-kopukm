...
export default function SectionOne() {
  return (
    <div className="h-[500px] w-full md:h-[600px] lg:h-[760px]">
      <div className="max-w-full mb-10 px-6">
        {/* Main Beranda */}
        <div className="flex px-8 sm:mx-auto mt-5 items-start justify-center gap-8">
          {/* Kiri Beranda */}
          <div className="flex-1">
            <h1
              className="max-w-3xl font-bold text-left text-2xl max-md:font-semibold md:text-3xl xl:text-5xl"
              style={{ wordSpacing: "0.20em", color: "#244563" }}
            >
              Bersama Membangun Ekonomi Kerakyatan yang Mandiri dan Berdaya Saing.
            </h1>

            <p
              className="mt-8 max-w-xl text-left text-xl"
              style={{ wordSpacing: "0.20em", color: "#244563" }}
            >
              Melalui portal ini, kami membuka akses seluas-luasnya bagi pelaku
              koperasi dan UMKM untuk memperoleh informasi, layanan, serta
              dukungan pembinaan. Bersama masyarakat dan berbagai pemangku
              kepentingan, kami berupaya menciptakan ekosistem usaha yang
              inklusif dan produktif demi kesejahteraan ekonomi Kabupaten
              Karawang.
            </p>
