...
// === Card Component ===
function StaticCard({ photo }: { photo: Photo }) {
  return (
        ...
        <div className="absolute bottom-0 right-0 w-56 md:w-64 lg:w-72">
          <div className="bg-white/90 backdrop-blur-md rounded-xl shadow-lg p-3 m-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                {photo.badge.title && (
                  <h4 className="text-sm font-semibold">{photo.badge.title}</h4>
                )}
                {photo.badge.subtitle && (
                  <p className="text-xs text-slate-500">{photo.badge.subtitle}</p>
                )}
              </div>
            </div>
          </div>
...
=======
  ...
  // Opsional: auto slide tiap 5 detik
  // useEffect(() => {
  ...
  return (
    <div className="relative w-[900px] h-[500px] mx-auto select-none flex items-center justify-center">
      <div className="w-[600px] h-[400px]">
        <StaticCard photo={current} />
      </div>
