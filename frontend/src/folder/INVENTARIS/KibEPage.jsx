...
export default function KibEPage() {
  ...
  const handleExportPDF = () => {
    Swal.fire(
      "Info",
      "Fitur Cetak Laporan KIB E sedang disiapkan.",
      "info"
    );
  };
  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 p-6 space-y-6">
      ...
      {/* TOMBOL CEK QR + DASHBOARD */}
      <div className="flex flex-col gap-4">

        {/* TOMBOL CEK QR */}
        <div className="flex justify-end">
          <button
            onClick={handleGoToScanE}
            className="flex items-center gap-2 px-5 py-3 bg-emerald-500 text-white rounded-2xl hover:bg-emerald-600 transition-all shadow-lg shadow-emerald-200 font-bold text-sm"
          >
            <QrCode size={18} />
            Cek QR
          </button>
