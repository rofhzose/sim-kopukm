...
export default function PrintKibETablePage() {
  ...
  return (
    <div className="p-8 bg-white min-h-screen text-black">
      <div className="text-center mb-6">
        <h1 className="text-xl font-bold uppercase">KARTU INVENTARIS BARANG (KIB) E</h1>
      ...
      <table className="w-full border-collapse border border-black text-xs">
        <thead>
          <tr className="bg-slate-100">
            ...
            <th className="border border-black p-2">No. Reg</th>
          ...
          {data.length === 0 ? (
            ...
            data.map((item, index) => (
              <tr key={index}>
                ...
                <td className="border border-black p-2">{item.nomor_register || "-"}</td>
